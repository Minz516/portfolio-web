...
export function About() {
  return (
    <section id="about" className="border-t border-outline-variant/30 py-20 lg:py-40">
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
          ...
          <div className="rounded-lg border border-outline-variant/50 bg-surface-low p-6 sm:p-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 font-display text-lg font-medium text-on-surface">
                ...
                <p className="mt-1 text-sm text-on-surface-variant">{site.education.location}</p>
              </div>
            </div>

            <div className="my-6 h-px bg-outline-variant/40" />
